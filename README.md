...
Sou **José Nathan**, desenvolvedor de software e analista de privacidade, graduando em Sistemas de Informação e apaixonado por transformar desafios reais em produtos digitais úteis, seguros e bem construídos.

- 🚀 Desenvolvimento de aplicações web completas, do banco de dados à interface.
- ☕ Back-end com **Java, Spring Boot, Node.js e APIs REST**.
- ⚛️ Front-end moderno com **React e JavaScript**.
- 🐳 Infraestrutura com **Docker, AWS e integração contínua**.
- 🔐 Interesse em qualidade de software, privacidade, segurança e experiência do usuário.
...
| Back-end | Front-end | Dados e APIs | Cloud e ferramentas |
|:---:|:---:|:---:|:---:|
| Java · Spring · Python · Node.js | React · JavaScript | SQL · PostgreSQL · Postman | Docker · AWS · GitHub Actions |
...
<details>
  ...
  <br />
  Sistema desenvolvido para apoiar o gerenciamento de atividades e informações agrícolas, reunindo tecnologia, organização e visão de produto.
  <br /><br />
  <a href="https://github.com/jsnatthan/AgroMetria"><strong>Explorar o AgroMetria →</strong></a>
</details>

<details>
  <summary><strong>📡 Radar Tech — oportunidades em tecnologia</strong></summary>
  <br />
  Plataforma completa de vagas com autenticação, perfil profissional, candidaturas, auditoria, painel administrativo, integrações externas e cobertura automatizada de qualidade.
  <br /><br />
  <a href="https://github.com/jsnatthan/radar-tech"><strong>Explorar o Radar Tech →</strong></a>
</details>
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/jsnatthan/jsnatthan/output/github-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/jsnatthan/jsnatthan/output/github-snake.svg" />
    <img width="100%" alt="Cobrinha percorrendo as contribuições" src="https://raw.githubusercontent.com/jsnatthan/jsnatthan/output/github-snake.svg" />
  </picture>
</div>
